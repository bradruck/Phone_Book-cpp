 ...
 * deleting elements from the tree and the propigating the changes in
...
public:
     ...
     */
    bool copyTree(const AVLTree& tree);
     ...
     */
    bool remove(Contact data);

    /*
     * Searches the entire AVL tree for a given key value.
     */
    bool searchID(int ID, Contact &Result) const;
    
    /*
     * Searches the entire AVL tree for a give field value as represented by
     * a string.
     */
    bool search(string str, vector<Contact> &Results) const;
    ...
    /*
     * Utility function for printing the data contents of every AVLNode within
     * this AVL tree.  Returns true if successful.
     */
    bool printTree() const;
    
    /*
     * Utility function for printing the data contents of one specified AVLNode 
     * within this AVL tree. Returns true if successful.
     */
    bool printNode(Contact data) const;

    /*
     * Utility function for writing the data contents of every AVLNode within
     * this AVLTree to a user identified file.  Exits program if successful.
     */
    bool writeTree(ostream& outfile) const;
...
protected:
     ...
     */
    unsigned int height(AVLNode* AVLNode);
     ...
     * @param AVLNode - The current AVLNode.
     */
    bool setBalance(AVLNode* AVLNode);
     ...
     * @param AVLNode - The current AVLNode.
     */
    void printBalance(AVLNode* AVLNode);
    
    /*
     * Recursive support function. Prints the data contents of every AVLNode in
     * the AVLTree.
     */
    void printTree(AVLNode* AVLNode) const;
    
    /*
    * Support function. Prints the entire data contents of a specified node.
    */
    void printNode(AVLNode* AVLNode, Contact Data) const;
    
    /*
     * Recursive support function. Writes the data contents of every AVLNode in
     * the AVLTree to a user defined ASCII text file.
     */
    void writeTree(AVLNode* AVLNode, ostream& outfile) const;
    
    /*
     * Recursive support function. Searches the entire tree to find a node with
     * a specified key value.
     */
    void searchID(AVLNode* node ,int ID, Contact &Result) const;

    /*
     * Recursive support function. Searches the entire tree to find any and all
     * nodes that contain a give field value as specified by a string.
     */
    void search(AVLNode* AVLNode ,string str, vector<Contact> &Results) const;
     ...
     * @param AVLNode - The current AVLNode.
     */
    unsigned int height(AVLNode* AVLNode) const;
     ...
     */
    void size(AVLNode* AVLNode, unsigned int& count) const;
     ...
     * @param AVLNode - The current AVLNode.
     */
    void preorder(std::stringstream& out, AVLNode* AVLNode) const;
    void inorder(std::stringstream& out, AVLNode* AVLNode) const;
    void postorder(std::stringstream& out, AVLNode* AVLNode) const;
    ...
    AVLNode* rotateLeftRight(AVLNode* AVLNode);
    AVLNode* rotateRightLeft(AVLNode* AVLNode);
     ...
     */
    AVLNode* copySubtree(AVLNode* AVLNode);
